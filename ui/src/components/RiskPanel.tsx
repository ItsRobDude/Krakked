...
export function RiskPanel({
  ...
  const getDisableReason = () => {
    ...
    if (isResume && drawdownGuard) return `Daily drawdown ${status.daily_drawdown_pct.toFixed(1)}% exceeds limit.`;
    if (isResume && driftGuard) return 'Price drift detected. Risk controls locked.';
    return undefined;
  };
