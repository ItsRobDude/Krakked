    ...
    <div className="modal-overlay">
      <div className="modal-content panel">
        ...
        <p className="panel__description">
          You are about to switch to <strong>Live Money</strong> execution.
          The bot will have authority to place real orders on your Kraken account.
        </p>
        ...
        <form onSubmit={handleSubmit} className="form">
          ...
          <div className="field field--checkbox">
            <label style={{ color: 'var(--color-danger)' }}>
              <input
                type="checkbox"
                checked={confirmPhrase}
                onChange={(e) => setConfirmPhrase(e.target.checked)}
                disabled={busy}
              />
          ...
          <div className="modal-actions">
            ...
            <button type="submit" className="primary-button" disabled={busy || !confirmPhrase}>
