...
from src.kraken_bot.portfolio.models import SpotPosition
...
class StrategyIntent:
    ...
    metadata: Dict[str, Any] = field(default_factory=dict) # free-form (e.g. indicators, scores)
...
class ExecutionPlan:
    ...
    metadata: Dict[str, Any] = field(default_factory=dict)   # e.g. equity snapshot, risk mode, etc.
