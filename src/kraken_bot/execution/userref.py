...
def resolve_userref(value: Optional[Union[str, int]]) -> Optional[int]:
    ...
    Performance Note: This function caches results via LRU. It avoids repeated
    SHA-256 hashing for the same strategy tags, drastically reducing overhead
    when generating identical orders frequently.
