...
This consolidated contract pulls in the latest versions of all seven phase documents from `docs/phases`.
It serves as the up-to-date single reference for the end-to-end design.
